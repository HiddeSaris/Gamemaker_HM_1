sound_engine = audio_play_sound(snd_engine, 20, true, 0);
engine_volume = 0;
...
boat_prices = [0, 150, 530, 1225, 2500];
...
bobber_on_land_text_timer = -1;

need_anchor_text_timer = -1;
...
fish_timer = -1
fish_timer_duration = 10 * 60 // time you have to wait for the fish
fish_timer_variation = 6 * 60
