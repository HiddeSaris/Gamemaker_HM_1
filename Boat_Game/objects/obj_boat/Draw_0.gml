...
if (not fishing)
{
	...
	draw_sprite_ext(spr_fishing_rod_lv0, 0, x + lengthdir_x(fishing_rod_len, fishing_rod_dir), y + lengthdir_y(fishing_rod_len, fishing_rod_dir), 1, 1, image_angle + 90, c_white, 1)
}
else 
{
	...
	draw_sprite_ext(spr_fishing_rod_lv0, frame_fishing_rod, person_x, person_y, 1, 1, image_angle, c_white, 1)
}
